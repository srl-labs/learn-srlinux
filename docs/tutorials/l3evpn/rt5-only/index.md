...
| **Lab components**          | 3x [SR Linux](https://github.com/nokia/srlinux-container-image) nodes, 2x [FRR](https://frrouting.org) nodes, 2 Alpine nodes                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| **Version information**[^1] | [`containerlab:v0.71.1`][clab-install], [`srlinux:25.10.1`][srlinux-container], [`frr:10.5.0`][frr-container] [`docker-ce:26.1.4`][docker-install]                                                                                                                                                                                                                                                                                                                                  |
...
```
containerlab deploy -c -t srl-labs/srl-l3evpn-basics-lab
```
